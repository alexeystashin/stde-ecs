...
namespace TdGame
{
    sealed class FinishGameSystem : IEcsInitSystem, IEcsRunSystem
    {
        ...
        [Inject]
        void Construct(GameState gameState, GameRules gameRules, Canvas gameCanvas)
        {
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            foreach (int entity in filter)
            {
                ...
                if (!gameState.isGameFinished)
                {
                    ...
                    var go = GameObject.Instantiate(PrefabCache.instance.GetPrefab(GamePrefabPath.gameResultWindow), gameCanvas.GetComponent<RectTransform>());
